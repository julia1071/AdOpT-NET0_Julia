...
if execute == 1:
    ...
    resultpath = "Z:/AdOpt_NET0/AdOpt_results/MY/Brownfield/Exportdemand/"
...
if execute == 1:
    # Specify the base path to your input data
    casepath = "Z:/AdOpt_NET0/AdOpt_casestudies/MY/Tests/MY_exportdemand/MY_Chemelot_gf_"
    resultpath = "Z:/AdOpt_NET0/AdOpt_results/MY/Greenfield/Exportdemand/"
